  ...
  handler: async (request, context) => {
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({ found: results.length > 0, count: items.length, version: 'v1', results, record: results[0] || null }),
      };
    } catch(e) {
      context.log('[labid-search] Error:', e.message);
