...
// ── Parameter config ──────────────────────────────────────────────────────────
const PARAM_CONFIG = [
  { name:'Chloride, Total',              rl:2.00,    epa:250,       unit:'mg/L', method:'SM4500Cl',         source:'gallery', cacheField:'field_6',  cacheDT:'field_7',  packages:['Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive','Pro Plus'] },
  { name:'Fluoride, Total',              rl:0.20,    epa:4,         unit:'mg/L', method:'SM4500F',          source:'gallery', cacheField:'field_8',  cacheDT:'field_9',  packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Nitrite-Nitrogen, Total',      rl:0.20,    epa:1,         unit:'mg/L', method:'EPA 354.1',        source:'gallery', cacheField:'field_10', cacheDT:'field_11', packages:['Basic Safety (FHA)','Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Nitrate-Nitrogen, Total',      rl:1.00,    epa:10,        unit:'mg/L', method:'SM4500NO3',        source:'gallery', cacheField:'field_12', cacheDT:'field_13', packages:['Basic Safety (FHA)','Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Arsenic, Total',               rl:1.00,    epa:10,        unit:'ug/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Arsenic_x0028_As75_x0029_',    packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Lead, Total',                  rl:1.00,    epa:15,        unit:'ug/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Lead_x0028_Pb208_x0029_',      packages:['Basic Safety (FHA)','Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Uranium, Total',               rl:1.00,    epa:30,        unit:'ug/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Uranium_x0028_U238_x0029_',    packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Copper, Total',                rl:0.001,   epa:1.3,       unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Copper_x0028_Cu63_x0029_',     packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Iron, Total',                  rl:0.05,    epa:0.3,       unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Iron_x0028_Fe54_x0029_',       packages:['Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Manganese, Total',             rl:0.001,   epa:0.05,      unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Manganese_x0028_Mn55_x0029_',  packages:['Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Sodium, Total',                rl:1.00,    epa:null,      unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Sodium_x0028_Na23_x0029_',     packages:['Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  ...
  { name:'Calcium, Total',               rl:0.2,     epa:null,      unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Calcium_x0028_Ca43_x0029_',    packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Magnesium, Total',             rl:0.1,     epa:null,      unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Magnesium_x0028_Mg24_x0029_',  packages:['Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'Antimony, Total',              rl:0.0005,  epa:0.006,     unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Antimony_x0028_Sb121_x0029_',  packages:['Comprehensive'] },
  { name:'Cadmium, Total',               rl:0.002,   epa:0.005,     unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Cadmium_x0028_Cd111_x0029_',   packages:['Comprehensive'] },
  { name:'Chromium, Total',              rl:0.002,   epa:0.1,       unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Chromium_x0028_Cr52_x0029_',   packages:['Comprehensive'] },
  { name:'Cobalt',                       rl:null,    epa:null,      unit:'mg/L', method:'EPA 200.8',        source:'icpms',   cacheField:'Cobalt_x0028_Co59_x0029_',     packages:['Comprehensive'] },
  ...
  { name:'Alkalinity',                   rl:40.00,   epa:null,      unit:'mg/L', method:'',                 source:'gallery', cacheField:'field_14', cacheDT:'field_15', packages:['WW - Expanded Safety','Comprehensive','Pro Plus'] },
  { name:'Sulfate',                      rl:40.00,   epa:250,       unit:'mg/L', method:'SM4500-SO4',       source:'gallery', cacheField:'field_16', cacheDT:'field_17', packages:['Comprehensive'] },
  { name:'Tannins',                      rl:null,    epa:null,      unit:'',     method:'Hach Method 8193', source:'gallery', cacheField:'field_18', cacheDT:'field_19', packages:['Pro Plus'] },
  { name:'Total Dissolved Solids (TDS)', rl:null,    epa:null,      unit:'ppm',  method:'SM4500C1E',        source:'gallery', cacheField:'field_20', cacheDT:'field_21', packages:['Pro Plus'] },
  { name:'Bromide',                      rl:null,    epa:null,      unit:'mg/L', method:'HI 93716',         source:'gallery', cacheField:'field_22', cacheDT:'field_23', packages:['Pro Plus'] },
  { name:'Total Coliform',               rl:null,    epa:1,         unit:'MPN',  method:'SM9223 B',         source:'bac',     cacheField:'field_2',                       packages:['Basic Safety (FHA)','Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
  { name:'E. Coli',                      rl:null,    epa:1,         unit:'MPN',  method:'SM9223 B',         source:'bac',     cacheField:'field_3',                       packages:['Basic Safety (FHA)','Standard Safety','Expanded Safety (Mortgage Test)','WW - Expanded Safety','Comprehensive'] },
];
